...
public class Enemy
{
  ...
  //The following functions return each of the different enemy subclass links.  This is used to determine where the enemies are going to be placed when each of the levels start.
  ...
  public void setIsDead() {
    //Only runs when the enemy is in a scenerio where it dies, such as when it is hit by a rock or by the GraveDigger when he has a potion.
    enemyIsDead = true;
  }
}
